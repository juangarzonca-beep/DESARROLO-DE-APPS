 ...
 */
export const getSafeAreaInsets = (doc) => {
 ...
 */
export const getElementCSSZoom = (el) => {
    if (!el) {
        return 1;
    }
    /**
 ...
 * returns (0, 0).
 */
export const getArrowDimensions = (arrowEl, zoom = 1) => {
    if (!arrowEl) {
 ...
 */
export const getPopoverDimensions = (size, contentEl, triggerEl, zoom = 1) => {
 ...
 */
export const getPopoverPosition = (isRTL, contentWidth, contentHeight, arrowWidth, arrowHeight, reference, side, align, defaultPosition, triggerEl, event, zoom = 1) => {
 ...
 */
export const calculateWindowAdjustment = (side, coordTop, coordLeft, bodyPadding, bodyWidth, bodyHeight, contentWidth, contentHeight, safeArea, contentOriginX, contentOriginY, triggerCoordinates, coordArrowTop = 0, coordArrowLeft = 0, arrowHeight = 0) => {
