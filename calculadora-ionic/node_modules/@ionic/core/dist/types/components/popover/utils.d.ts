 ...
 */
export declare const getElementCSSZoom: (el: HTMLElement | null) => number;
/**
 * Returns the dimensions of the popover
 * arrow on `ios` mode. If arrow is disabled
 * returns (0, 0).
 */
export declare const getArrowDimensions: (arrowEl: HTMLElement | null, zoom?: number) => {
    arrowWidth: number;
    arrowHeight: number;
};
/**
 ...
 */
export declare const getPopoverDimensions: (size: PopoverSize, contentEl: HTMLElement, triggerEl?: HTMLElement, zoom?: number) => {
    contentWidth: number;
