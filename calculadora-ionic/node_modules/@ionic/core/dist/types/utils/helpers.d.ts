 ...
 */
export declare const onCustomPropertyChange: (hostEl: HTMLElement | null | undefined, property: string, callback: (value: number) => void, initialValue?: number) => (() => void);
/**
 ...
 */
export declare const isEndSide: (side: Side, hostEl?: HTMLElement) => boolean;
