 ...
 */
import { r as registerInstance, i as config, a as printIonWarning, h, f as Host, g as getElement, d as createEvent, e as readTask, j as forceUpdate, w as writeTask, c as printIonError } from './index-Ci0c0wtC.js';
import { v as shouldUseCloseWatcher, n as getOverlaySizeType } from './overlays-D2Bo1FJ7.js';
import { a as isPlatform, b as getIonMode } from './ionic-global-D319UM2i.js';
import { i as inheritAriaAttributes, h as hasLazyBuild, c as componentOnReady, e as clamp, v as shallowEqualStringMap } from './helpers-D3HlaZqB.js';
import { i as isRTL } from './dir-Dojwmvde.js';
import { h as hostContext, c as createColorClasses } from './theme-byZM6qHV.js';
import { b as findIonContent, p as printIonContentErrorMsg, g as getScrollElement } from './index-BBArCvE7.js';
import { c as createKeyboardController } from './keyboard-controller-kCdrbtXb.js';
import { g as getTimeGivenProgression } from './cubic-bezier-hHmYLOfE.js';
import { a as attachComponent, d as detachComponent } from './framework-delegate-Dyvjs63n.js';
import { c as createLockController } from './lock-controller-B-hirT0v.js';
import { t as transition } from './index-65Eftz2j.js';
    ...
    componentDidLoad() {
        {
            this.rIC(async () => {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./index-BcTd8Van.js').then((module) => module.startTapClick(config));
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-D3yqZrEP.js').then((module) => module.startStatusTap());
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    ...
                    import('./input-shims-pdb7CjZn.js').then((module) => module.startInputShims(config, platform));
                }
                const hardwareBackButtonModule = await import('./overlays-D2Bo1FJ7.js').then(function (n) { return n.w; });
                ...
                if (typeof window !== 'undefined') {
                    import('./keyboard-BPq0DuxS.js').then((module) => module.startKeyboardAssist(window));
                }
...
const Content = class {
    ...
    render() {
        ...
        this.resize();
        return (h(Host, { key: 'e1013621096729354ef92915af52dd823e69fdff', role: isMainContent ? 'main' : undefined, class: createColorClasses(this.color, {
                [mode]: true,
            ...
            }, ...inheritedAttributes }, h("div", { key: '3d8649b164d6324beaa1bc50e1d204ad06c2ec1a', ref: (el) => (this.backgroundContentEl = el), id: "background-content", part: "background" }), fixedSlotPlacement === 'before' ? h("slot", { name: "fixed" }) : null, h("div", { key: 'dd2d3bed8690b4f5027a43f5ec60e7e7df18106d', class: {
                'inner-scroll': true,
                'scroll-x': scrollX,
                'scroll-y': scrollY,
                overscroll: (scrollX || scrollY) && forceOverscroll,
            }, ref: (scrollEl) => (this.scrollEl = scrollEl), onScroll: this.scrollEvents ? (ev) => this.onScroll(ev) : undefined, part: "scroll" }, h("slot", { key: 'dc3d4584d9e9afd43699525a619b8e873078fbbf' })), transitionShadow ? (h("div", { class: "transition-effect" }, h("div", { class: "transition-cover" }), h("div", { class: "transition-shadow" }))) : null, fixedSlotPlacement === 'after' ? h("slot", { name: "fixed" }) : null));
    }
    get el() { return getElement(this); }
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await import('./swipe-back-DDOJz7NH.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => this.ani?.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
                this.ani.onFinish(() => {
                    this.gestureOrAnimationInProgress = false;
                    if (this.swipeHandler) {
