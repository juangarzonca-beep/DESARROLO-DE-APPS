 ...
 */
import { r as registerInstance, d as createEvent, i as config, a as printIonWarning, h, f as Host, g as getElement, j as forceUpdate } from './index-Ci0c0wtC.js';
import { E as ENABLE_HTML_CONTENT_DEFAULT } from './config-DWCzVL3Y.js';
import { g as getSlottedClickContent, c as createSlotMutationController, a as createNotchController, b as createStartContainerController, d as createClickController } from './slot-mutation-controller-B_Gyzsmn.js';
...
import { b as inheritAttributes, a as renderHiddenInput, p as focusVisibleElement } from './helpers-D3HlaZqB.js';
import { p as popoverController, b as actionSheetController, a as alertController, m as modalController, s as safeCall } from './overlays-D2Bo1FJ7.js';
import { i as isRTL } from './dir-Dojwmvde.js';
import { r as reflectPropertiesToAttributes, a as sanitizeDOMTree, b as blockedTags } from './index-B2E_HqxY.js';
...
const SelectPopover = class {
    ...
    render() {
        ...
        return (h(Host, { key: '4b4ac4a4b6523147e7c1f5e29dd8043867f2baea', class: getIonMode(this) }, h("ion-list", { key: 'f700d3dc3ce68c20a4d981164b29262564097fb4' }, header !== undefined && h("ion-list-header", { key: '196bcd7963f13ef8bc46231545eee4cb8d526f5e' }, header), hasSubHeaderOrMessage && (h("ion-item", { key: 'bb108e0aa2409997df35f52cb67e58e55e0fd630' }, h("ion-label", { key: '59e8d9196ff976f3835766662654c0f085e58ec3', class: "ion-text-wrap" }, subHeader !== undefined && h("h3", { key: '532f75d7c129ffadca4e6cbb619a4427aaede65c' }, subHeader), message !== undefined && h("p", { key: 'fc42c91594b9001e983cb5e4176fc4c9bff0f708' }, message)))), this.renderOptions(options))));
    }
    get el() { return getElement(this); }
};
SelectPopover.style = {
