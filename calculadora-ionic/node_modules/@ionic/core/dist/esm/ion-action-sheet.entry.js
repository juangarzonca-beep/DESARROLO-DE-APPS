 ...
 */
import { r as registerInstance, d as createEvent, e as readTask, h, f as Host, g as getElement } from './index-Ci0c0wtC.js';
...
import { c as createDelegateController, d as createTriggerController, B as BACKDROP, i as isCancel, e as present, f as dismiss, g as eventMethod, s as safeCall, h as prepareOverlay, r as restoreRootFocusTrapAccessibility, j as cleanupRootFocusTrapAccessibility, k as setOverlayId } from './overlays-D2Bo1FJ7.js';
...
const ActionSheet = class {
    ...
    renderActionSheetButtons(filteredButtons) {
        ...
        return filteredButtons.map((b, index) => {
            ...
            return (h("button", { ...htmlAttrs, role: isRadio ? 'radio' : undefined, type: "button", id: buttonId, class: {
                    ...buttonClass(b),
