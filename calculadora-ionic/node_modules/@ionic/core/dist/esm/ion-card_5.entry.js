 ...
 */
import { r as registerInstance, h, f as Host, g as getElement, j as forceUpdate } from './index-Ci0c0wtC.js';
import { a as createAttributeController } from './attribute-controller-BrbFqJRn.js';
import { o as openURL, c as createColorClasses } from './theme-byZM6qHV.js';
import { b as getIonMode } from './ionic-global-D319UM2i.js';
import './helpers-D3HlaZqB.js';
...
const Card = class {
    ...
    renderCard(mode) {
        ...
        return (h(TagType, { ...attrs, ...inheritedAriaAttributes, class: "card-native", part: "native", disabled: this.disabled, onClick: (ev) => openURL(href, ev, routerDirection, routerAnimation) }, h("slot", null), clickable && mode === 'md' && h("ion-ripple-effect", null)));
    }
    render() {
        const mode = getIonMode(this);
        return (h(Host, { key: '104412c26f53cce36432c3bb4d9e38bbe00c5816', class: createColorClasses(this.color, {
                [mode]: true,
