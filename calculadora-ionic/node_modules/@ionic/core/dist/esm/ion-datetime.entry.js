 ...
 */
import { c as printIonError, a as printIonWarning, r as registerInstance, d as createEvent, w as writeTask, i as config, h, f as Host, g as getElement } from './index-Ci0c0wtC.js';
import { startFocusVisible } from './focus-visible-BmVRXR1y.js';
import { r as raf, g as getElementRoot, a as renderHiddenInput } from './helpers-D3HlaZqB.js';
import { F as FOCUS_TRAP_DISABLE_CLASS } from './overlays-D2Bo1FJ7.js';
...
`, this.el);
    ...
    render() {
        ...
        return (h(Host, { key: 'a9128b5c55464e30a269daf9d725bf430c8c655c', "aria-disabled": disabled ? 'true' : null, onFocus: this.onFocus, onBlur: this.onBlur, class: {
            ...
            } }, h("div", { key: 'b49f3a98db2b7cf535d7ea894d518f75f8a1fefb', class: "intersection-tracker", ref: (el) => (this.intersectionTrackerRef = el) }), this.renderDatetime(mode)));
    }
