...
import { f as addEventListener, m as removeEventListener, a as renderHiddenInput } from './helpers-D3HlaZqB.js';
...
const RadioGroup = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8d926a17e800adf0184274215c9689c96a8d6dfd', role: "radiogroup", "aria-labelledby": label ? labelId : null, "aria-describedby": this.hintTextId, "aria-invalid": this.isInvalid ? 'true' : undefined, onClick: this.onClick, class: mode }, this.renderHintText(), h("slot", { key: '2ff891123d5971a581b70d0886d23a074358c2dc' })));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "value": [{
