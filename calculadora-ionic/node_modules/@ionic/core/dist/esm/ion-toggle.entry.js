 ...
 */
import { r as registerInstance, d as createEvent, i as config, h, f as Host, g as getElement, j as forceUpdate } from './index-Ci0c0wtC.js';
import { i as inheritAriaAttributes, a as renderHiddenInput } from './helpers-D3HlaZqB.js';
import { i as isRTL } from './dir-Dojwmvde.js';
import { c as createItemMultipleInputsObserver } from './item-multiple-inputs-CtLCJNiL.js';
import { c as checkInvalidState } from './validity-DJztqcrH.js';
import { c as hapticSelection } from './haptic-B3RodENJ.js';
...
import { j as checkmarkOutline, r as removeOutline, k as ellipseOutline } from './index-BvabGprD.js';
...
const Toggle = class {
    constructor(hostRef) {
        ...
        this.setupGesture = async () => {
            ...
            if (toggleTrack) {
                this.gesture = (await import('./index-BmLuEdV7.js')).createGesture({
                    el: toggleTrack,
                    gestureName: 'toggle',
                    gesturePriority: 100,
                    threshold: 5,
    ...
    render() {
        ...
        return (h(Host, { key: '148d15040257b05b3769da5a2439d051e357cbba', role: "switch", "aria-checked": `${checked}`, "aria-describedby": this.hintTextId, "aria-invalid": this.isInvalid ? 'true' : undefined, onClick: this.onClick, "aria-labelledby": hasLabel ? inputLabelId : null, "aria-label": inheritedAttributes['aria-label'] || null, "aria-disabled": disabled ? 'true' : null, "aria-required": required ? 'true' : undefined, tabindex: disabled ? undefined : 0, onKeyDown: this.onKeyDown, onFocus: this.onFocus, onBlur: this.onBlur, class: createColorClasses(color, {
                [mode]: true,
                'in-item': inItem,
                ...
                [`toggle-${rtl}`]: true,
            }) }, h("label", { key: '0dbc40adc87e2ab4bdcd9a9fef43393484174c18', class: "toggle-wrapper", htmlFor: inputId }, h("input", { key: '92dee565687fc9a883f97091ead1bbb51df43779', type: "checkbox", role: "switch", "aria-checked": `${checked}`, checked: checked, disabled: disabled, id: inputId, required: required, ...inheritedAttributes }), h("div", { key: 'f057bc57714b26e84226ee931e09212b86dba69f', class: {
