 ...
 */
import { w as win, p as focusVisibleElement, c as componentOnReady, g as getElementRoot, n as doc, f as addEventListener, m as removeEventListener } from './helpers-D3HlaZqB.js';
import { i as config, c as printIonError, a as printIonWarning } from './index-Ci0c0wtC.js';
import { b as getIonMode } from './ionic-global-D319UM2i.js';
import { C as CoreDelegate } from './framework-delegate-Dyvjs63n.js';
import { B as BACKDROP_NO_SCROLL } from './gesture-controller-B_gJaBk0.js';
...
export { BACKDROP as B, FOCUS_TRAP_DISABLE_CLASS as F, GESTURE as G, MENU_BACK_BUTTON_PRIORITY as M, OVERLAY_GESTURE_PRIORITY as O, alertController as a, actionSheetController as b, createDelegateController as c, createTriggerController as d, present as e, dismiss as f, eventMethod as g, prepareOverlay as h, isCancel as i, cleanupRootFocusTrapAccessibility as j, setOverlayId as k, loadingController as l, modalController as m, getOverlaySizeType as n, focusFirstDescendant as o, popoverController as p, getPresentedOverlay as q, restoreRootFocusTrapAccessibility as r, safeCall as s, toastController as t, focusLastDescendant as u, shouldUseCloseWatcher as v, hardwareBackButton as w };
