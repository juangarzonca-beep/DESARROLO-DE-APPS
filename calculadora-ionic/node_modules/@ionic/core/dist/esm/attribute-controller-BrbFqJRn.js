 ...
 */
import { b as inheritAttributes, w as win, q as ariaAttributes } from './helpers-D3HlaZqB.js';
 ...
 */
const createAttributeController = (el, attributes, onChange, hostOwnedAttributes = []) => {
 ...
 */
const createAriaAttributeController = (el, onChange, hostOwnedAttributes = []) => {
    return createAttributeController(el, ariaAttributes, onChange, hostOwnedAttributes);
};

export { createAttributeController as a, createAriaAttributeController as c };
