...
var attributeController = require('./attribute-controller-B0BsgXV8.js');
...
const Item = class {
    ...
    componentWillLoad() {
         ...
         * reads it twice.
         */
        this.ariaController = attributeController.createAttributeController(this.el, ['aria-label'], () => index.forceUpdate(this));
    }
    componentDidLoad() {
        helpers.raf(() => {
            this.setMultipleInputs();
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7fe924642310c19f057ae1bfa29c1acdf5cc7ed6', "aria-disabled": ariaDisabled, class: {
                ...childStyles,
                ...labelColorStyles,
            ...
            }, role: inList ? 'listitem' : null }, index.h(TagType, { key: '8fddfb2a076b4b98e45ee8b23579d011dba12acb', ...attrs, ...inheritedAriaAttributes, class: "item-native", part: "native", disabled: disabled, ...clickFn }, index.h("slot", { key: '7f888b62b2023cf501fd308e32629e7a291c2d05', name: "start", onSlotchange: this.updateInteractivityOnSlotChange }), index.h("div", { key: '6d5cdde307caa65b131edb65cb0a5f8294cf151c', class: "item-inner", part: "inner" }, index.h("div", { key: '9fbfffdff4cf51adf1f02d573953cf8b145574b0', class: "input-wrapper", part: "container" }, index.h("slot", { key: '574c7e61cdaa3959a28bad7353105ef217a76ed9', onSlotchange: this.updateInteractivityOnSlotChange })), index.h("slot", { key: 'ed7e211960cd65ed17f865a6d50d5bdde069416b', name: "end", onSlotchange: this.updateInteractivityOnSlotChange }), showDetail && (index.h("ion-icon", { key: '2847bb21f42e9d5ab8ea86262b2bc1c3b3f7c902', icon: detailIcon, lazy: false, class: "item-detail-icon", part: "detail-icon", "aria-hidden": "true", "flip-rtl": detailIcon === index$1.chevronForward }))), canActivate && mode === 'md' && index.h("ion-ripple-effect", { key: '55502ef394db0953144387fa3baebf9fa6a976a9' }))));
    }
...
const ItemDivider = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'b191727cc26c600287fd856e49216bf1ae1d5aad', class: theme.createColorClasses(this.color, {
                [mode]: true,
                'item-divider-sticky': this.sticky,
                item: true,
            }) }, index.h("slot", { key: 'a8e2eb48ca858b64da8ad018fa8d1667030b7143', name: "start" }), index.h("div", { key: '3219e0b76ac4a96db50a67f1f2794a235111c613', class: "item-divider-inner", part: "inner" }, index.h("div", { key: '31a64775153cd8704458e0e2a4a512096585deb4', class: "item-divider-wrapper", part: "container" }, index.h("slot", { key: 'd46dfb578028790eb6ccaac5e6009a5d96aa831a' })), index.h("slot", { key: 'a5fc7ac27e418ea82d9dcc913a8dae7e35493760', name: "end" }))));
    }
    get el() { return index.getElement(this); }
};
ItemDivider.style = {
...
const ItemGroup = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'd24ee9c70a99d11b7d95dfb4a8066670bdfcbc1d', role: "group", class: {
                [mode]: true,
...
const Label = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '461604c1887f322dc13d7df3d5cdbb7ee1361117', class: theme.createColorClasses(this.color, {
                [mode]: true,
                'in-item-color': theme.hostContext('ion-item.ion-color', this.el),
                [`label-${position}`]: position !== undefined,
                [`label-no-animate`]: this.noAnimate,
                'label-rtl': document.dir === 'rtl',
            }) }, index.h("slot", { key: 'a7005d0a217641278aa8e95144e8e4b9ae87a1c5' })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "color": [{
...
const List = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b21e063d568b07331ea9443647b3faf33265256a', role: "list", class: {
                [mode]: true,
                // Used internally for styling
                [`list-${mode}`]: true,
                'list-inset': inset,
...
const ListHeader = class {
    ...
    render() {
        const { lines } = this;
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '92ab17533e169b1a1c990285449e0546aac98021', class: theme.createColorClasses(this.color, {
                [mode]: true,
                [`list-header-lines-${lines}`]: lines !== undefined,
            }) }, index.h("div", { key: '26639255577380a8e70b61f753aa9ed57590694f', class: "list-header-inner", part: "inner" }, index.h("slot", { key: 'f69055e7a7a47ae8dcbbe289e18b6630f0792714' }))));
    }
};
ListHeader.style = {
...
const Note = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'ffe9b4de8bbd89b1ef427f6cd5dbcd354d715e6b', class: theme.createColorClasses(this.color, {
                [mode]: true,
            }) }, index.h("slot", { key: '42fa3ca3f98208ea2a5057da25b7f9d371c5ba1f' })));
    }
};
Note.style = {
    ios: noteIosCss(),
...
const SkeletonText = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '1114e5caf6419e9458db8256480b39e6989963b2', class: {
                [mode]: true,
                'skeleton-text-animated': animated,
                'in-media': inMedia,
            } }, index.h("span", { key: '9137cf837f163fc0653437fc003666cddac103b0' }, "\u00A0")));
    }
    get el() { return index.getElement(this); }
};
