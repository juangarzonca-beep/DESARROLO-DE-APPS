...
const Nav = class {
    ...
    async componentDidLoad() {
        ...
        this.didLoad = true;
        this.rootChanged();
        this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-CMxnx1Rv.js'); })).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
    ...
    async transition(enteringView, leavingView, ti) {
        ...
        const animationOpts = {
            ...
            baseEl: this.el,
            progressCallback,
            animated: this.animated && index.config.getBoolean('animated', true),
            enteringEl,
            leavingEl,
            ...opts,
            animationBuilder: opts.animationBuilder || this.animation || index.config.get('navAnimation'),
        };
    ...
    render() {
        return index.h("slot", { key: '1886154d3c2fa8511af4d641d269aaa4c0f45c05' });
    }
...
const NavLink = class {
    ...
    render() {
        return index.h(index.Host, { key: '4bcaa74015462824b3f19253b04a77ce83389ca0', onClick: this.onClick });
    }
    get el() { return index.getElement(this); }
};
