...
var format = require('./format-BHIqanHK.js');
    ...
    constructor(hostRef) {
        ...
        this.setDateTimeText = async () => {
            ...
            switch (datetimePresentation) {
                case 'date-time':
                case 'time-date':
                    const dateText = format.getLocalizedDateTime(locale, firstParsedDatetime, formatOptions?.date ?? { month: 'short', day: 'numeric', year: 'numeric' });
                    const timeText = format.getLocalizedTime(locale, firstParsedDatetime, computedHourCycle, formatOptions?.time);
                    if (preferWheel) {
                ...
                case 'date':
                    if (multiple && parsedValues.length !== 1) {
                        ...
                        this.dateText = format.getLocalizedDateTime(locale, firstParsedDatetime, formatOptions?.date ?? { month: 'short', day: 'numeric', year: 'numeric' });
                    }
                    break;
                case 'time':
                    this.timeText = format.getLocalizedTime(locale, firstParsedDatetime, computedHourCycle, formatOptions?.time);
                    break;
                case 'month-year':
                    this.dateText = format.getLocalizedDateTime(locale, firstParsedDatetime, formatOptions?.date ?? { month: 'long', year: 'numeric' });
                    break;
                case 'month':
                    this.dateText = format.getLocalizedDateTime(locale, firstParsedDatetime, formatOptions?.time ?? { month: 'long' });
                    break;
                case 'year':
                    this.dateText = format.getLocalizedDateTime(locale, firstParsedDatetime, formatOptions?.time ?? { year: 'numeric' });
                    break;
            }
        };
        /**
