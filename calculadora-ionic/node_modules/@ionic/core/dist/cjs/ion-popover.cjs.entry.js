...
var index$1 = require('./index-78cPCZwH.js');
 ...
 * returns (0, 0).
 */
const getArrowDimensions = (arrowEl, zoom = 1) => {
    if (!arrowEl) {
 ...
 */
const getPopoverDimensions = (size, contentEl, triggerEl, zoom = 1) => {
 ...
 */
const getPopoverPosition = (isRTL, contentWidth, contentHeight, arrowWidth, arrowHeight, reference, side, align, defaultPosition, triggerEl, event, zoom = 1) => {
...
const Popover = class {
    constructor(hostRef) {
        ...
        this.configureTriggerInteraction = () => {
            ...
            if (!triggerEl) {
                index.printIonWarning(`[ion-popover] - A trigger element with the ID "${trigger}" was not found in the DOM. The trigger element must be in the DOM when the "trigger" property is set on ion-popover.`, this.el);
                return;
            }
    ...
    componentWillLoad() {
        const { el } = this;
        const popoverId = this.htmlAttributes?.id ?? hardwareBackButton.setOverlayId(el);
    ...
    async present(event) {
        ...
        await hardwareBackButton.present(this, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
    ...
    async dismiss(data, role, dismissParentPopover = true) {
        ...
        const shouldDismiss = await hardwareBackButton.dismiss(this, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, this.event);
        if (shouldDismiss) {
            if (destroyKeyboardInteraction) {
                destroyKeyboardInteraction();
     ...
     */
    onDidDismiss() {
        return hardwareBackButton.eventMethod(this.el, 'ionPopoverDidDismiss');
    }
    /**
     * Returns a promise that resolves when the popover will dismiss.
     */
    onWillDismiss() {
        return hardwareBackButton.eventMethod(this.el, 'ionPopoverWillDismiss');
    }
    render() {
        ...
        return (index.h(index.Host, { key: 'b5e9c788f58397203976d5f8302dfb89e916efe1', "aria-modal": "true", "no-router": true, tabindex: "-1", ...htmlAttributes, style: {
            ...
            }, onIonPopoverDidPresent: onLifecycle, onIonPopoverWillPresent: onLifecycle, onIonPopoverWillDismiss: onLifecycle, onIonPopoverDidDismiss: onLifecycle, onIonBackdropTap: this.onBackdropTap }, !parentPopover && index.h("ion-backdrop", { key: 'f3977833c5b2c0087c286ee54363b478d69eb115', tappable: this.backdropDismiss, visible: this.showBackdrop, part: "backdrop" }), index.h("div", { key: '1059893d6fd2932ca8adcdf8d45a5d66f4794727', class: "popover-wrapper ion-overlay-wrapper", onClick: dismissOnSelect ? () => this.dismiss() : undefined }, enableArrow && index.h("div", { key: '24d7988bdd95882ad77fcaa7112aeda55878bee4', class: "popover-arrow", part: "arrow" }), index.h("div", { key: '4d6992e0a9d629f11763045f9199f9a77fa521ab', class: "popover-content", part: "content" }, index.h("slot", { key: 'b29747419620a01a6c34e9e846cd529b0b210145' })))));
    }
