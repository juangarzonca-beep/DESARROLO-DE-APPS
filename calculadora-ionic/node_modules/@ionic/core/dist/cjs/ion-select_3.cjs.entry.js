...
const Select = class {
    constructor(hostRef) {
        ...
        this.required = false;
        this.onClick = (ev) => {
            const slotted = slotMutationController.getSlottedClickContent(ev, this.el);
            /**
    ...
    async connectedCallback() {
        ...
        this.startContainerController.calculateStartContainerWidth();
        this.clickController = slotMutationController.createClickController(el);
    ...
    async openPopover(ev) {
        ...
        return hardwareBackButton.popoverController.create(popoverOpts);
    }
    async openActionSheet() {
        ...
        return hardwareBackButton.actionSheetController.create(actionSheetOpts);
    }
    async openAlert() {
        const interfaceOptions = this.interfaceOptions;
        const inputType = this.multiple ? 'checkbox' : 'radio';
        ...
        return hardwareBackButton.alertController.create(alertOpts);
    }
    openModal() {
        ...
        return hardwareBackButton.modalController.create(modalOpts);
    }
    /**
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '31585557ac49c439939b5a084867f5039dc2f1ce', onClick: this.onClick, class: theme.createColorClasses(this.color, {
                [mode]: true,
                'in-item': inItem,
            ...
            }) }, index.h("label", { key: '368f5f0c77550be6a743752dd1acbfe9915f0a3d', class: "select-wrapper", id: "select-label", onClick: this.onLabelClick, part: "wrapper" }, hasOutlineFill && this.renderOutlineContainer(), index.h("div", { key: '2e9039eaa15f398ebe54808ff659db89d3621681', class: "select-start", part: "start", ref: (el) => (this.startContainerEl = el) }, index.h("slot", { key: 'b83e362f89bd8cbc564ad7122778e3a0f08be66d', name: "start" })), index.h("div", { key: 'f55ac9fc3bbd9a4a3819a101a3780fc02ae8a8e0', class: "select-control", part: "control" }, this.renderLabel(), index.h("div", { key: 'e32984e57cda5cf341af8e354a2aef5a114827c0', class: "native-wrapper", ref: (el) => (this.nativeWrapperEl = el), part: "container" }, this.renderSelectText(), this.renderListbox(), !hasFloatingOrStackedLabel && this.renderSelectIcon())), index.h("div", { key: 'fc4cb7c392c46129afe709d9557ad9a10d72b564', class: "select-end", part: "end" }, hasFloatingOrStackedLabel && this.renderSelectIcon(), index.h("slot", { key: '6d65c92cdafe985a769fb3b41a58625077803eef', name: "end" })), shouldRenderHighlight && index.h("div", { key: '9a912c64d7cd77f074a069d126cd0bada1b71eed', class: "select-highlight" })), this.renderBottomContent()));
    }
...
const textForValue = (opts, value, compareWith, useHTML = false) => {
    ...
    const customHTMLEnabled = index.config.get('innerHTMLTemplatesEnabled', config.ENABLE_HTML_CONTENT_DEFAULT);
    if (!selectOpt) {
        return null;
    }
...
const SelectPopover = class {
    ...
    callOptionHandler(ev) {
        ...
        if (option?.handler) {
            hardwareBackButton.safeCall(option.handler, values);
        }
    }
    /**
