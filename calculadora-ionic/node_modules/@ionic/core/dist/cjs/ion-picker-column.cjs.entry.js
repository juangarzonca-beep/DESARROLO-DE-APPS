...
var haptic = require('./haptic-C-wyDL4O.js');
...
const PickerColumn = class {
    constructor(hostRef) {
        ...
        this.watchForOutsidePress = () => {
            helpers.doc?.addEventListener('pointerdown', this.onPointerDownOutside, { capture: true });
        };
        this.stopWatchingForOutsidePress = () => {
            helpers.doc?.removeEventListener('pointerdown', this.onPointerDownOutside, { capture: true });
        };
        /**
        ...
        this.settle = () => {
            ...
            this.enableHaptics && haptic.hapticSelectionEnd();
            /**
        ...
        this.initializeScrollListener = () => {
            this.enableHaptics = ionicGlobal.isPlatform('ios');
            ...
            const scrollCallback = () => {
                helpers.raf(() => {
                    ...
                    this.resetScrollEndTimeout();
                    if (!this.isScrolling) {
                        this.enableHaptics && haptic.hapticSelectionStart();
                    ...
                    const referenceNode = hasParentShadow ? rootNode : helpers.doc;
                    /**
                    ...
                    if (newActiveElement !== activeEl) {
                        this.enableHaptics && haptic.hapticSelectionChanged();
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '60a893619d0b01fba53fbccef67a10d533a22657', class: theme.createColorClasses(color, {
                [mode]: true,
                ['picker-column-active']: isActive,
                ['picker-column-numeric-input']: numericInput,
                ['picker-column-disabled']: disabled,
            }) }, index.h("slot", { key: '79f1e047f89c5ec916ed02efaac56ef3f73b8969', name: "prefix" }), index.h("div", { key: 'c45c86e88353a196ff38159f40f390bc27852c9e', class: "picker-opts", ref: (el) => {
                this.scrollEl = el;
            }, role: "slider", tabindex: this.disabled ? undefined : 0, "aria-label": this.ariaLabel, "aria-valuemin": 0, "aria-valuemax": 0, "aria-valuenow": 0, "aria-valuetext": this.getOptionValueText(this.activeItem), "aria-orientation": "vertical", onKeyDown: (ev) => this.onKeyDown(ev) }, index.h("div", { key: 'e02d76752f5d3dd4cd2846fbc28645f1508a4b49', class: "picker-item-empty", "aria-hidden": "true" }, "\u00A0"), index.h("div", { key: 'd577bcbadc530970b2781692b050811633625c5a', class: "picker-item-empty", "aria-hidden": "true" }, "\u00A0"), index.h("div", { key: 'c89e78c3a896bc1f55b922d01df16fdbb1259bdd', class: "picker-item-empty", "aria-hidden": "true" }, "\u00A0"), index.h("slot", { key: '6c597ff899692597432ee2aa0b42de53b86deed4' }), index.h("div", { key: '91686ed94f14c47647836ed4d63e54b5c54ee3b9', class: "picker-item-empty", "aria-hidden": "true" }, "\u00A0"), index.h("div", { key: '2ff058c6d0e8cef4e143c2d848f9a52684579af1', class: "picker-item-empty", "aria-hidden": "true" }, "\u00A0"), index.h("div", { key: 'bc7386bec6fced36e44084a7a137b3fe6506c996', class: "picker-item-empty", "aria-hidden": "true" }, "\u00A0")), index.h("slot", { key: '8835fd3f4e025bce964e6f05984c9aaadc20d7fb', name: "suffix" })));
    }
