...
var slotMutationController = require('./slot-mutation-controller-ByWHY518.js');
...
const Textarea = class {
    ...
    debounceChanged() {
         ...
         */
        this.ionInput = debounce === undefined ? originalIonInput ?? ionInput : helpers.debounceEvent(ionInput, debounce);
    }
    /**
    ...
    connectedCallback() {
        ...
        this.startContainerController.calculateStartContainerWidth();
        this.clickController = slotMutationController.createClickController(el, () => this.nativeInput);
    ...
    componentWillLoad() {
        this.inheritedAttributes = {
            ...helpers.inheritAriaAttributes(this.el),
            ...helpers.inheritAttributes(this.el, ['data-form-type', 'title', 'tabindex', 'dir']),
        };
    }
    componentDidLoad() {
    ...
    renderOutlineContainer() {
        return (index.h("div", { class: "textarea-outline-container" }, index.h("div", { class: "textarea-outline-start" }), index.h("div", { class: {
    ...
    renderHintText() {
        ...
        return [
            index.h("div", { id: helperTextId, class: "helper-text", "aria-live": "polite" }, !isInvalid ? helperText : null),
            index.h("div", { id: errorTextId, class: "error-text", role: "alert" }, isInvalid ? errorText : null),
        ];
    }
    getHintTextID() {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0f01ed6565313c45beaea5e0aa429a86b9cfa1a0', class: theme.createColorClasses(this.color, {
                [mode]: true,
                'has-value': hasValue,
                'has-focus': hasFocus,
            ...
            }) }, index.h("label", { key: 'a59548c3d3bf66543fd6e06b5c3b6e649f963164', class: "textarea-wrapper", htmlFor: inputId, onClick: this.onLabelClick }, hasOutlineFill && this.renderOutlineContainer(), index.h("div", { key: '29055193d664d9fe84ba0340fdcbbc54fec0e403', class: "textarea-start", ref: (el) => (this.startContainerEl = el) }, index.h("slot", { key: '2cc122d9541ce7ae3c2309c27123b6c6c91cbfc7', name: "start" })), index.h("div", { key: 'c847a6fa1eaf6ef2b296415cd72bdd3aee9828a2', class: "textarea-control" }, this.renderLabel(), index.h("div", { key: 'f9205f82d6346daa86dc7e0f6e1eb221c76ed7b0', class: "native-wrapper", ref: (el) => (this.textareaWrapper = el) }, index.h("textarea", { key: '0bdb517fa5b3a44eeb3bb2ed1f9a8eab21a9a6a1', class: "native-textarea", ref: (el) => (this.nativeInput = el), id: inputId, disabled: disabled, autoCapitalize: this.autocapitalize, autoFocus: this.autofocus, enterKeyHint: this.enterkeyhint, inputMode: this.inputmode, minLength: this.minlength, maxLength: this.maxlength, name: this.name, placeholder: this.placeholder || '', readOnly: this.readonly, required: this.required, spellcheck: this.spellcheck, cols: this.cols, rows: this.rows, wrap: this.wrap, onInput: this.onInput, onChange: this.onChange, onBlur: this.onBlur, onFocus: this.onFocus, onKeyDown: this.onKeyDown, "aria-describedby": this.getHintTextID(), "aria-invalid": this.isInvalid ? 'true' : undefined, ...this.inheritedAttributes }, value))), index.h("div", { key: '1ce661b800ef12146bdb97fb193e22be227ea052', class: "textarea-end" }, index.h("slot", { key: 'aca5704db48fe8e0e784cf57f2978ae2d63b3edc', name: "end" })), shouldRenderHighlight && index.h("div", { key: 'd916816d44cbdb4bc9a05032c5490eaa9bf3ba47', class: "textarea-highlight" })), this.renderBottomContent()));
    }
