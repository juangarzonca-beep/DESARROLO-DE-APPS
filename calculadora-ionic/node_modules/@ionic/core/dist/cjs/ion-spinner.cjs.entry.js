...
const Spinner = class {
    ...
    getName() {
        const spinnerName = this.name || index.config.get('spinner');
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '87102ff9ea58b0ecde5d0978386374f7d0e9cf98', class: theme.createColorClasses(self.color, {
                [mode]: true,
