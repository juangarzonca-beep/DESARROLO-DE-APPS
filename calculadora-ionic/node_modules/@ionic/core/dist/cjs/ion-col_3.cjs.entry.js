...
const Col = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e12293a4315cb474bbde73421dd0b4129f1df1cc', class: {
                [mode]: true,
            }, style: {
                ...
                ...this.calculateSize(),
            } }, index.h("slot", { key: '869317ea6574111a57a7a9d096c53d264c335d28' })));
    }
};
Col.style = colCss();
...
const Row = class {
    ...
    render() {
        return (index.h(index.Host, { key: '12b7419dd67ff18dd00e1bf5093299bd94c75503', class: ionicGlobal.getIonMode(this) }, index.h("slot", { key: '43fc76a289ecaf398a77a90034ee576003a826fd' })));
    }
};
Row.style = rowCss();
