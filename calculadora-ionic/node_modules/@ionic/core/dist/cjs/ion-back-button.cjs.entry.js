...
const BackButton = class {
    ...
    componentWillLoad() {
        ...
        if (this.defaultHref === undefined) {
            this.defaultHref = index.config.get('backButtonDefaultHref');
        }
    }
    get backButtonIcon() {
        ...
        if (ionicGlobal.getIonMode(this) === 'ios') {
            ...
            return index.config.get('backButtonIcon', index$1.chevronBack);
        }
        // default md back button icon
        return index.config.get('backButtonIcon', index$1.arrowBackSharp);
    }
    get backButtonText() {
        const defaultBackButtonText = ionicGlobal.getIonMode(this) === 'ios' ? 'Back' : null;
        return this.text != null ? this.text : index.config.get('backButtonText', defaultBackButtonText);
    }
    get hasIconOnly() {
