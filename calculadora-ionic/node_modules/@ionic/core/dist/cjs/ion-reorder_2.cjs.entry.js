...
var index$2 = require('./index-m83Rr85o.js');
...
const Reorder = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f278c473b4695a6a93565100e4fcaa7f9e3e9ff5', class: mode }, index.h("slot", { key: 'cc26b5ed297f68a0bea82e27e34a7fe945186f4e' }, index.h("ion-icon", { key: '696f5e4c2b09e64bd08abf0d0818b1554cd29737', icon: reorderIcon, lazy: false, class: "reorder-icon", part: "icon", "aria-hidden": "true" }))));
    }
...
const ReorderGroup = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '779332508f44409696b6bab80eda72f9b1d7869d', class: {
                [mode]: true,
