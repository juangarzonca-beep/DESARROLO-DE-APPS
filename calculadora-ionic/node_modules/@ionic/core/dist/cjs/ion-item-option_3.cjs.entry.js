...
const ItemOption = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a10d36e60d61865141c57c03a114e4845b400a55', onClick: this.onClick, class: theme.createColorClasses(this.color, {
                [mode]: true,
                'item-option-disabled': disabled,
                'item-option-expandable': expandable,
                'ion-activatable': true,
            }) }, index.h(TagType, { key: '5cc49ef73318213f6202d1d0f460f629ea65f17f', ...attrs, class: "button-native", part: "native", disabled: disabled }, index.h("span", { key: '0643b16660b4ca00b0f3b4dbe2739e9ce076abea', class: "button-inner", part: "inner" }, index.h("slot", { key: '8778d6d09aa9e0db278ce00c5456a1acfe82c15f', name: "top" }), index.h("div", { key: '4fc849494c8cb2380015161e096b5c61cf517d90', class: "horizontal-wrapper", part: "container" }, index.h("slot", { key: '9d0c0a5a63d8ec636df9c85d48bbdb39fb63af5e', name: "start" }), index.h("slot", { key: 'a40561497c7e7d73173edd24ed335230e6eebb2b', name: "icon-only" }), index.h("slot", { key: 'b94f2a4aa5bf4a1104497ced1920d6ee43d33659' }), index.h("slot", { key: '91713dbb3e6a617c00f950857f2ed5e5ffceaa9a', name: "end" })), index.h("slot", { key: 'f5af33c3bfb50fc629a06e1120bba55da07b2afb', name: "bottom" })), mode === 'md' && index.h("ion-ripple-effect", { key: 'fc56e1644ef9c5b2e1e66683465a7fd09c05215c' }))));
    }
...
const ItemOptions = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6e60ff004d48bf7701711e518ec0b21264496ae8', class: {
                [mode]: true,
...
const ItemSliding = class {
    ...
    async updateOptions() {
         ...
         * option as `end`.
         */
        await Promise.all(options.map((option) => new Promise((resolve) => helpers.componentOnReady(option, resolve))));
        let sides = 0;
        // Reset left and right options in case they were removed
        this.leftOptions = this.rightOptions = undefined;
        for (const option of options) {
            const side = helpers.isEndSide(option.side ?? option.getAttribute('side')) ? 'end' : 'start';
            if (side === 'start') {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '02174ca963753d3a51a4249068f3d436f8acb03d', class: {
                [mode]: true,
