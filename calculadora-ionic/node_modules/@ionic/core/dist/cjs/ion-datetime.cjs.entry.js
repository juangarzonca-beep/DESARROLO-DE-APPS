...
`, this.el);
    ...
    renderWheelPicker(forcePresentation = this.presentation) {
        ...
        return index.h("ion-picker", { class: hardwareBackButton.FOCUS_TRAP_DISABLE_CLASS }, renderArray);
    }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a9128b5c55464e30a269daf9d725bf430c8c655c', "aria-disabled": disabled ? 'true' : null, onFocus: this.onFocus, onBlur: this.onBlur, class: {
            ...
            } }, index.h("div", { key: 'b49f3a98db2b7cf535d7ea894d518f75f8a1fefb', class: "intersection-tracker", ref: (el) => (this.intersectionTrackerRef = el) }), this.renderDatetime(mode)));
    }
