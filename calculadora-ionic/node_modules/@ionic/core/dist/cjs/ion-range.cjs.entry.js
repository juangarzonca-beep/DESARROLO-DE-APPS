...
const Range = class {
    constructor(hostRef) {
        ...
        this.setupActivatedObserver = () => {
            ...
            const syncActivated = () => {
                this.activatedKnob = knobHandleA?.classList.contains('ion-activated')
                    ? 'A'
                    : knobHandleB?.classList.contains('ion-activated')
                        ? 'B'
                        : undefined;
            };
    ...
    minChanged(newValue) {
        if (!helpers.isSafeNumber(newValue)) {
            this.min = 0;
        }
        if (!this.noUpdate) {
            this.updateRatio();
    ...
    activeBarStartChanged() {
        ...
        if (activeBarStart !== undefined) {
            if (activeBarStart > this.max) {
                index.printIonWarning(`[ion-range] - The value of activeBarStart (${activeBarStart}) is greater than the max (${this.max}). Valid values are greater than or equal to the min value and less than or equal to the max value.`, this.el);
                this.activeBarStart = this.max;
            }
            else if (activeBarStart < this.min) {
                index.printIonWarning(`[ion-range] - The value of activeBarStart (${activeBarStart}) is less than the min (${this.min}). Valid values are greater than or equal to the min value and less than or equal to the max value.`, this.el);
    ...
    componentWillLoad() {
        ...
        this.min = helpers.isSafeNumber(this.min) ? this.min : 0;
        this.max = helpers.isSafeNumber(this.max) ? this.max : 100;
        this.step = helpers.isSafeNumber(this.step) ? this.step : 1;
    }
    componentDidLoad() {
    ...
    connectedCallback() {
        ...
        const ionContent = index$1.findClosestIonContent(this.el);
    ...
    renderRangeSlider() {
        ...
        return (index.h("div", { class: "range-slider", ref: (rangeEl) => (this.rangeSlider = rangeEl), onPointerDown: () => {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '72f253ee1514b4c5874a6720c2f954fae7a7c4d4', onFocusin: this.onFocus, onFocusout: this.onBlur, id: rangeId, class: theme.createColorClasses(this.color, {
                [mode]: true,
                'in-item': inItem,
            ...
            }) }, index.h("label", { key: '9b96b83a6118ee2a79d8adbb0a58197470308179', class: "range-wrapper", id: "range-label" }, index.h("div", { key: 'c7b31a7c87c20857a26624bd94501df6420fceec', class: {
                'label-text-wrapper': true,
                'label-text-wrapper-hidden': !hasLabel,
            }, part: "label" }, label !== undefined ? index.h("div", { class: "label-text" }, label) : index.h("slot", { name: "label" })), index.h("div", { key: '4ca15b9370097e140550489ff24979f3a959e65b', class: "native-wrapper" }, index.h("slot", { key: 'f110896c68741bad92239f98b6028cbe0ad5122f', name: "start" }), this.renderRangeSlider(), index.h("slot", { key: '5c4031c4403fa643ee2e11637b2420ddd8cbc4ce', name: "end" })))));
    }
...
const renderKnob = (rtl, { knob, position, dualKnobs, value, ratio, min, max, disabled, activated, focused, hovered, pressed, pin, handleKeyboard, pinFormatter, inheritedAttributes, onKnobFocus, onKnobBlur, onKnobMouseEnter, onKnobMouseLeave, }) => {
    ...
    return (index.h("div", { onKeyDown: (ev) => {
            ...
            .filter(Boolean)
            .join(' '), style: knobStyle(), role: "slider", tabindex: disabled ? -1 : 0, "aria-label": ariaLabel !== undefined ? ariaLabel : null, "aria-labelledby": ariaLabel === undefined ? 'range-label' : null, "aria-valuemin": min, "aria-valuemax": max, "aria-disabled": disabled ? 'true' : null, "aria-valuenow": value }, pin && (index.h("div", { class: "range-pin", role: "presentation", part: [
            'pin',
            ...
            .filter(Boolean)
            .join(' ') }, pinFormatter(value))), index.h("div", { class: "range-knob", role: "presentation", part: [
            'knob',
