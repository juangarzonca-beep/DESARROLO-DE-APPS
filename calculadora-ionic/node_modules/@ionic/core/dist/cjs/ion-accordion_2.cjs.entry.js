...
const Accordion = class {
    constructor(hostRef) {
        ...
        this.shouldAnimate = () => {
            ...
            const animated = index.config.get('animated', true);
            if (!animated) {
                return false;
            }
    ...
    render() {
        ...
        this.setAria(expanded);
        return (index.h(index.Host, { key: '5c58b3809a4636d69f0f9957ecf1f50c42cdfc03', class: {
                [mode]: true,
            ...
            }, tabindex: disabled ? '-1' : undefined }, index.h("div", { key: 'f76bc02347639b41c9a5be8a9488a8be8559cba7', onClick: () => this.toggleExpanded(), id: "header", part: headerPart, "aria-controls": "content", ref: (headerEl) => (this.headerEl = headerEl) }, index.h("slot", { key: 'e01744bf0af3200239e82c60c632ed36295db2da', name: "header" })), index.h("div", { key: 'c613345a7e244ee361f76ff4ebed139d2a1b9572', id: "content", part: contentPart, role: "region", "aria-labelledby": "header", ref: (contentEl) => (this.contentEl = contentEl) }, index.h("div", { key: '943b65d9a129759b4c213974ae5ed777b5f6166e', id: "content-wrapper", ref: (contentElWrapper) => (this.contentElWrapper = contentElWrapper) }, index.h("slot", { key: 'b0df520dad9d5557df63a35f8206ada4a765d238', name: "content" })))));
    }
...
`, this.el);
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'd1a79a93179474fbba66fcf11a92f4871dacc975', class: {
                [mode]: true,
                'accordion-group-disabled': disabled,
                'accordion-group-readonly': readonly,
                [`accordion-group-expand-${expand}`]: true,
            }, role: "presentation" }, index.h("slot", { key: 'e6b8954b686d1fbb4fc92adb07fddc97a24b0a31' })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "value": [{
