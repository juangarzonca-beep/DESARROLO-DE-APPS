...
const Radio = class {
    ...
    connectedCallback() {
        ...
        this.itemFocusObserver = itemMultipleInputs.createItemMultipleInputsObserver(this.el, () => index.forceUpdate(this));
    }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ad7ac0bdc4d3216ecc19402e5b8d6f9e4d09334b', onFocus: this.onFocus, onBlur: this.onBlur, onClick: this.onClick, class: theme.createColorClasses(color, {
                [mode]: true,
                'in-item': inItem,
            ...
            }), role: "radio", "aria-checked": checked ? 'true' : 'false', "aria-disabled": disabled ? 'true' : null, tabindex: buttonTabindex }, index.h("label", { key: '59c09125633120e2000447b8a3bc24c54490aa85', class: "radio-wrapper" }, index.h("div", { key: '1a98f3e0027deeac52647ba37aa9a99be0231966', class: {
                'label-text-wrapper': true,
                'label-text-wrapper-hidden': !hasLabel,
            }, part: "label" }, index.h("slot", { key: '6a48e76ac8793d2aacebd3a8f193e3537272e5c2' })), index.h("div", { key: '68e4350bac8dad29c6b7a180560de2bb4dfc8c41', class: "native-wrapper" }, this.renderRadioControl()))));
    }
...
const RadioGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8d926a17e800adf0184274215c9689c96a8d6dfd', role: "radiogroup", "aria-labelledby": label ? labelId : null, "aria-describedby": this.hintTextId, "aria-invalid": this.isInvalid ? 'true' : undefined, onClick: this.onClick, class: mode }, this.renderHintText(), index.h("slot", { key: '2ff891123d5971a581b70d0886d23a074358c2dc' })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "value": [{
