...
const SegmentView = class {
    ...
    handleScroll(ev) {
        ...
        const scrollRatio = (dir.isRTL(this.el) ? -1 : 1) * (scrollLeft / max);
    ...
    async setContent(id, smoothScroll = true) {
        ...
        this.el.scrollTo({
            top: 0,
            left: (dir.isRTL(this.el) ? -1 : 1) * offset,
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b3cd48fead5d2877ead68cf6d81955fc31530c7a', class: {
                'segment-view-disabled': disabled,
                'segment-view-scroll-disabled': isManualScroll === false,
                'segment-view-swipe-disabled': swipeGesture === false,
            } }, index.h("slot", { key: 'ad5aa8b79790c490e13438afa0cbb2c241eab0a1' })));
    }
