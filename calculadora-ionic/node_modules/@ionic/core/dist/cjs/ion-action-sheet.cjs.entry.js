...
const ActionSheet = class {
    ...
    async present() {
        ...
        await hardwareBackButton.present(this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
        unlock();
    }
    /**
    ...
    async dismiss(data, role) {
        const unlock = await this.lockController.lock();
        const dismissed = await hardwareBackButton.dismiss(this, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
        if (dismissed) {
     ...
     */
    onDidDismiss() {
        return hardwareBackButton.eventMethod(this.el, 'ionActionSheetDidDismiss');
    }
    /**
     ...
     */
    onWillDismiss() {
        return hardwareBackButton.eventMethod(this.el, 'ionActionSheetWillDismiss');
    }
    ...
    async callButtonHandler(button) {
        if (button) {
            ...
            const rtn = await hardwareBackButton.safeCall(button.handler);
            if (rtn === false) {
    ...
    getRadioButtons() {
        return this.getButtons().filter((b) => {
            ...
            return role === 'radio' && !hardwareBackButton.isCancel(role);
        });
    }
    /**
    ...
    setupButtonActiveGesture() {
        ...
        if (ionicGlobal.getIonMode(this) !== 'ios' || !wrapperEl || !groupEl) {
            return;
        }
        index.readTask(() => {
    ...
    renderActionSheetButtons(filteredButtons) {
        ...
        return filteredButtons.map((b, index$1) => {
            ...
            return (index.h("button", { ...htmlAttrs, role: isRadio ? 'radio' : undefined, type: "button", id: buttonId, class: {
                    ...buttonClass(b),
                    ...
                    this.buttonClick(b);
                }, disabled: b.disabled, tabIndex: tabIndex }, index.h("span", { class: "action-sheet-button-inner" }, b.icon && index.h("ion-icon", { icon: b.icon, "aria-hidden": "true", lazy: false, class: "action-sheet-icon" }), selectOptionRender.renderOptionLabel(optionLabelOptions, 'action-sheet-button-label', true)), mode === 'md' && index.h("ion-ripple-effect", null)));
        });
    }
    render() {
        ...
        return (index.h(index.Host, { key: '83b47ea6b81d4eec6582c1dcaae6f267c78ba634', role: "dialog", "aria-modal": "true", "aria-labelledby": header !== undefined ? headerID : null, tabindex: "-1", ...htmlAttributes, style: {
            ...
            }, onIonActionSheetWillDismiss: this.dispatchCancelHandler, onIonBackdropTap: this.onBackdropTap }, index.h("ion-backdrop", { key: '3652793ec76adcfb87b814eb65d1260ae26f6910', tappable: this.backdropDismiss }), index.h("div", { key: '7de3a51daf95b50e02734a2cc8eec6f55b1473f3', tabindex: "0", "aria-hidden": "true" }), index.h("div", { key: '9b76bbf12901b956f7ee6d984f7f71e169bb5939', class: "action-sheet-wrapper ion-overlay-wrapper", ref: (el) => (this.wrapperEl = el) }, index.h("div", { key: 'cb52c905275a46ff27810fb1b4748ab533a78c45', class: "action-sheet-container" }, index.h("div", { key: '578c7194cfbcb65c1e41e15c390af41f179a2686', class: "action-sheet-group", ref: (el) => (this.groupEl = el), role: hasRadioButtons ? 'radiogroup' : undefined }, header !== undefined && (index.h("div", { key: 'ee961307c25cb1fcb0c6bbf667a8ed76ab717860', id: headerID, class: {
                'action-sheet-title': true,
                'action-sheet-has-sub-title': this.subHeader !== undefined,
            } }, header, this.subHeader && index.h("div", { key: '82d4016010db14d3f3b9911c276cb9a63b960ef4', class: "action-sheet-sub-title" }, this.subHeader))), this.renderActionSheetButtons(buttons)), cancelButton && (index.h("div", { key: 'a88fbfab194e13c6642a65f2e19a12299dd4ac23', class: "action-sheet-group action-sheet-group-cancel" }, index.h("button", { key: 'a232b8d23f1fc2efb7b37a605102b6994761a2f6', ...cancelButton.htmlAttributes, type: "button", class: buttonClass(cancelButton), onClick: () => this.buttonClick(cancelButton) }, index.h("span", { key: '19a7d95d3428d78a56b7dacabdec8fc0b722d8c2', class: "action-sheet-button-inner" }, cancelButton.icon && (index.h("ion-icon", { key: '5f3f3cb996a48e6365a3a09ea72ddc68ac9ccb78', icon: cancelButton.icon, "aria-hidden": "true", lazy: false, class: "action-sheet-icon" })), cancelButton.text), mode === 'md' && index.h("ion-ripple-effect", { key: '6e8fcb5f103ac19aa4b0682f19791cef0a147001' })))))), index.h("div", { key: '36f63ab77949c88f662e2cf6bb18510cb9de6a9f', tabindex: "0", "aria-hidden": "true" })));
    }
