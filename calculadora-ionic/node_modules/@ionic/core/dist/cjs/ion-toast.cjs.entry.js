...
var index$2 = require('./index-D9PPKWTO.js');
...
function getAnimationPosition(position, positionAnchor, mode, toast) {
    ...
    if (positionAnchor && helpers.win) {
        ...
        if (position === 'top') {
             ...
             */
            offset -= helpers.win.innerHeight - box.top;
        }
        /**
...
function warnIfAnchorIsHidden(positionAnchor, toast) {
    if (positionAnchor.offsetParent === null) {
        index.printIonWarning('[ion-toast] - The positionAnchor element for ion-toast was found in the DOM, but appears to be hidden. This may lead to unexpected positioning of the toast.', toast);
    }
}
/**
...
const Toast = class {
    constructor(hostRef) {
         ...
         */
        this.duration = index.config.getNumber('toastDuration', 0);
        /**
        ...
        this.createSwipeGesture = (toastPosition) => {
            const gesture = (this.gesture = createSwipeToDismissGesture(this.el, toastPosition, () => {
                 ...
                 */
                this.dismiss(undefined, hardwareBackButton.GESTURE);
            }));
            gesture.enable(true);
        };
        /**
    ...
    async present() {
        ...
        await hardwareBackButton.present(this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, {
            position,
    ...
    async dismiss(data, role) {
        ...
        const dismissed = await hardwareBackButton.dismiss(this, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, 
        /**
     ...
     */
    onDidDismiss() {
        return hardwareBackButton.eventMethod(this.el, 'ionToastDidDismiss');
    }
    /**
     * Returns a promise that resolves when the toast will dismiss.
     */
    onWillDismiss() {
        return hardwareBackButton.eventMethod(this.el, 'ionToastWillDismiss');
    }
    getButtons() {
    ...
    getAnchorElement() {
        ...
        if (position === 'middle' && positionAnchor !== undefined) {
            index.printIonWarning('[ion-toast] - The positionAnchor property is ignored when using position="middle".', this.el);
            return undefined;
        }
        if (typeof positionAnchor === 'string') {
            ...
            if (foundEl === null) {
                index.printIonWarning(`[ion-toast] - An anchor element with an ID of "${positionAnchor}" was not found in the DOM.`, el);
                return undefined;
            }
            return foundEl;
        }
        ...
        index.printIonWarning('[ion-toast] - Invalid positionAnchor value:', positionAnchor, el);
        return undefined;
    }
    ...
    async callButtonHandler(button) {
        if (button?.handler) {
            ...
            try {
                ...
                index.printIonError('[ion-toast] - Exception in callButtonHandler:', e);
            }
        }
        return true;
    }
    ...
    renderToastMessage(key, ariaHidden = null) {
        ...
        if (customHTMLEnabled) {
            return (index.h("div", { key: key, "aria-hidden": ariaHidden, class: "toast-message", part: "message", innerHTML: index$2.sanitizeDOMString(message) }));
        }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '15d2ff8b689e40bb5cae3e304448dadf91b11b88', tabindex: "-1", ...this.htmlAttributes, style: {
                zIndex: `${60000 + this.overlayIndex}`,
            }, class: theme.createColorClasses(this.color, {
                [mode]: true,
                ...theme.getClassMap(this.cssClass),
                'overlay-hidden': true,
                'toast-translucent': this.translucent,
            }), onIonToastWillDismiss: this.dispatchCancelHandler }, index.h("div", { key: 'd26cc17a59e3d81810e22ee422398f2cc4c7a05c', class: wrapperClass, part: "wrapper" }, index.h("div", { key: 'f15e1a97f13defcbf96612df4c7ba45999e6244d', class: "toast-container", part: "container" }, this.renderButtons(startButtons, 'start'), this.icon !== undefined && (index.h("ion-icon", { key: '639cacec828f969673071e54dc68284050e9f2fd', class: "toast-icon", part: "icon", icon: this.icon, lazy: false, "aria-hidden": "true" })), index.h("div", { key: 'a07e68cf68e4c507e4515de1a4b43dd8fb3541d3', class: "toast-content", part: "content", role: "status", "aria-atomic": "true", "aria-live": "polite" }, !revealContentToScreenReader && header !== undefined && this.renderHeader('oldHeader', 'true'), !revealContentToScreenReader && message !== undefined && this.renderToastMessage('oldMessage', 'true'), revealContentToScreenReader && header !== undefined && this.renderHeader('header'), revealContentToScreenReader && message !== undefined && this.renderToastMessage('header')), this.renderButtons(endButtons, 'end')))));
    }
...
const buttonPart = (button) => {
    return hardwareBackButton.isCancel(button.role) ? 'button cancel' : 'button';
};
Toast.style = {
    ios: toastIosCss(),
    md: toastMdCss()
