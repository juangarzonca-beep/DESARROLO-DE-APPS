...
const FabList = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '03a8920c29a93c6df4bab14753a78a8a30722ce8', class: {
                [mode]: true,
                'fab-list-active': this.activated,
                [`fab-list-side-${this.side}`]: true,
            } }, index.h("slot", { key: 'd9e1541cb044e209bc2dff14080f3b938a2b84ae' })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "activated": [{
