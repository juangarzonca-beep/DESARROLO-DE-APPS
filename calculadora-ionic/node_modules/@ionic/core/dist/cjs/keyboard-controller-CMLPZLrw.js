...
const getResizeContainer = (resizeMode) => {
     ...
     */
    if (helpers.doc === undefined || resizeMode === keyboard.KeyboardResize.None || resizeMode === undefined) {
        return null;
    }
    /**
     ...
     */
    const ionApp = helpers.doc.querySelector('ion-app');
    return ionApp ?? helpers.doc.body;
};
/**
...
const createKeyboardController = async (keyboardChangeCallback) => {
    ...
    const init = async () => {
        ...
        helpers.win?.addEventListener('keyboardWillShow', keyboardWillShowHandler);
        helpers.win?.addEventListener('keyboardWillHide', keyboardWillHideHandler);
    };
    ...
    const destroy = () => {
        helpers.win?.removeEventListener('keyboardWillShow', keyboardWillShowHandler);
        helpers.win?.removeEventListener('keyboardWillHide', keyboardWillHideHandler);
