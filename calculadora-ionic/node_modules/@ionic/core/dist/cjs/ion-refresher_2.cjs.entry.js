...
var index$3 = require('./index-D9PPKWTO.js');
...
const Refresher = class {
    ...
    async setupiOSNativeRefresher(pullingSpinner, refreshingSpinner) {
        ...
        const { createGesture } = await Promise.resolve().then(function () { return require('./index-DRPqwSvU.js'); });
        /**
    ...
    async connectedCallback() {
        ...
        helpers.componentOnReady(contentEl, async () => {
             ...
             */
            this.scrollEl = await index$1.getScrollElement(customScrollTarget ?? contentEl);
            /**
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fd9c8e51155d56f12148e8eb547e45c05807b4b5', slot: "fixed", class: {
                [mode]: true,
...
const RefresherContent = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'a1546008813bbcfa70f97e9b9025846ee0aed722', class: mode }, index.h("div", { key: '5422771d67fe201e22d4f9d7db6b685f3db5d99d', class: "refresher-pulling" }, this.pullingIcon && hasSpinner && (index.h("div", { key: '5c2b6dfc3f01b42586ea83380548d454b220a7ca', class: "refresher-pulling-icon" }, index.h("div", { key: '2c3799ca3f66960d7081c63c5a0840951f694baf', class: "spinner-arrow-container" }, index.h("ion-spinner", { key: '03f766a9b9354dcb8f6975757a9b882c2eb5cf4a', name: this.pullingIcon, paused: true }), mode === 'md' && this.pullingIcon === 'circular' && (index.h("div", { key: 'e5f4ba7c6a70adb71f8985af0e23aca07d7b005a', class: "arrow-container" }, index.h("ion-icon", { key: 'ddccbd9164ae8daa97178fc53b52f74f1fd298ef', icon: index$2.caretBackSharp, "aria-hidden": "true" })))))), this.pullingIcon && !hasSpinner && (index.h("div", { key: '6fb742f47f9149fa6dc3daefe5aaa77f925da4bd', class: "refresher-pulling-icon" }, index.h("ion-icon", { key: '907657135eeac4c394be1eae4a659664a7bfacb0', icon: this.pullingIcon, lazy: false, "aria-hidden": "true" }))), this.pullingText !== undefined && this.renderPullingText()), index.h("div", { key: 'fb3094b3ed7e100ab9641c3221770889088e27f3', class: "refresher-refreshing" }, this.refreshingSpinner && (index.h("div", { key: 'bc8078f94e7cea3cb6f03a09e98540f0e0b38721', class: "refresher-refreshing-icon" }, index.h("ion-spinner", { key: '8f39524f073aa828e941bcdd4d48e4d5dfc759c6', name: this.refreshingSpinner }))), this.refreshingText !== undefined && this.renderRefreshingText())));
    }
    get el() { return index.getElement(this); }
};
