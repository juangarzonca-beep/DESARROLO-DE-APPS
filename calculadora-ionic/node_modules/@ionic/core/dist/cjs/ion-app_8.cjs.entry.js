...
var index$1 = require('./index-m83Rr85o.js');
var keyboardController = require('./keyboard-controller-CMLPZLrw.js');
var cubicBezier = require('./cubic-bezier-DAjy1V-e.js');
var frameworkDelegate = require('./framework-delegate-CvJ6SkeA.js');
var lockController = require('./lock-controller-aDB9wrEf.js');
var index$2 = require('./index-78cPCZwH.js');
    ...
    componentDidLoad() {
        {
            this.rIC(async () => {
                ...
                if (!index.config.getBoolean('_testing')) {
                    Promise.resolve().then(function () { return require('./index-7glr9oHu.js'); }).then((module) => module.startTapClick(index.config));
                }
                if (index.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-CL5oy8nW.js'); }).then((module) => module.startStatusTap());
                }
                if (index.config.getBoolean('inputShims', needInputShims())) {
                    ...
                    Promise.resolve().then(function () { return require('./input-shims-gtEasMEV.js'); }).then((module) => module.startInputShims(index.config, platform));
                }
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./overlays-BEVysBKh.js'); }).then(function (n) { return n.hardwareBackButton; });
                ...
                if (typeof window !== 'undefined') {
                    Promise.resolve().then(function () { return require('./keyboard-CrDGk8Si.js'); }).then((module) => module.startKeyboardAssist(window));
                }
...
const Content = class {
     ...
     */
    readSizeToContent() {
        if (theme.hostContext('ion-popover', this.el)) {
            return true;
        }
        ...
        return hardwareBackButton.getOverlaySizeType(height) === 'content';
    }
    resize() {
        /**
    ...
    render() {
        ...
        this.resize();
        return (index.h(index.Host, { key: 'e1013621096729354ef92915af52dd823e69fdff', role: isMainContent ? 'main' : undefined, class: theme.createColorClasses(this.color, {
                [mode]: true,
            ...
            }, ...inheritedAttributes }, index.h("div", { key: '3d8649b164d6324beaa1bc50e1d204ad06c2ec1a', ref: (el) => (this.backgroundContentEl = el), id: "background-content", part: "background" }), fixedSlotPlacement === 'before' ? index.h("slot", { name: "fixed" }) : null, index.h("div", { key: 'dd2d3bed8690b4f5027a43f5ec60e7e7df18106d', class: {
                'inner-scroll': true,
                'scroll-x': scrollX,
                'scroll-y': scrollY,
                overscroll: (scrollX || scrollY) && forceOverscroll,
            }, ref: (scrollEl) => (this.scrollEl = scrollEl), onScroll: this.scrollEvents ? (ev) => this.onScroll(ev) : undefined, part: "scroll" }, index.h("slot", { key: 'dc3d4584d9e9afd43699525a619b8e873078fbbf' })), transitionShadow ? (index.h("div", { class: "transition-effect" }, index.h("div", { class: "transition-cover" }), index.h("div", { class: "transition-shadow" }))) : null, fixedSlotPlacement === 'after' ? index.h("slot", { name: "fixed" }) : null));
    }
    get el() { return index.getElement(this); }
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-CMxnx1Rv.js'); })).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => this.ani?.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
                this.ani.onFinish(() => {
                    this.gestureOrAnimationInProgress = false;
                    if (this.swipeHandler) {
    ...
    async commit(enteringEl, leavingEl, opts) {
        ...
        try {
            ...
            index.printIonError('[ion-router-outlet] - Exception in commit:', e);
        }
        unlock();
        return changed;
    }
    ...
    render() {
        return index.h("slot", { key: '249e7d8a063c781db52fa535e42d648c7bf2909a' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "swipeGesture": [{
...
const ToolbarTitle = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        const size = this.getSize();
        return (index.h(index.Host, { key: 'c5f0b913ff0a22d9bf02da48a313a613c2ac8fe7', class: theme.createColorClasses(this.color, {
                [mode]: true,
                [`title-${size}`]: true,
                'title-rtl': document.dir === 'rtl',
            }) }, index.h("div", { key: '5253b9e39fb764bfe1e57370719139f8a83e9904', class: "toolbar-title" }, index.h("slot", { key: 'e38b1eccb0175c36f8cab211aee7ce4d61fc9035' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "size": [{
...
const Toolbar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c16803dc4eae9972ef19bf43aa74b94feb4fd4c1', class: {
                ...childStyles,
