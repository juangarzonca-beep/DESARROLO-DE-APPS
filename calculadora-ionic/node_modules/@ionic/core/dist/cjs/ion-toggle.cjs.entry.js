...
var itemMultipleInputs = require('./item-multiple-inputs-n1sInjA_.js');
...
const Toggle = class {
    ...
    async connectedCallback() {
        ...
        this.itemFocusObserver = itemMultipleInputs.createItemMultipleInputsObserver(el, () => index.forceUpdate(this), [
    ...
    render() {
        ...
        const inMultipleInputsItem = theme.hostContext('ion-item.item-multiple-inputs', el);
        ...
        const inClickableItem = theme.hostContext('ion-item.ion-activatable, ion-item[button], ion-item[href]', el);
        helpers.renderHiddenInput(true, el, name, checked ? value : '', disabled);
        return (index.h(index.Host, { key: '148d15040257b05b3769da5a2439d051e357cbba', role: "switch", "aria-checked": `${checked}`, "aria-describedby": this.hintTextId, "aria-invalid": this.isInvalid ? 'true' : undefined, onClick: this.onClick, "aria-labelledby": hasLabel ? inputLabelId : null, "aria-label": inheritedAttributes['aria-label'] || null, "aria-disabled": disabled ? 'true' : null, "aria-required": required ? 'true' : undefined, tabindex: disabled ? undefined : 0, onKeyDown: this.onKeyDown, onFocus: this.onFocus, onBlur: this.onBlur, class: theme.createColorClasses(color, {
                [mode]: true,
                'in-item': inItem,
                ...
                [`toggle-${rtl}`]: true,
            }) }, index.h("label", { key: '0dbc40adc87e2ab4bdcd9a9fef43393484174c18', class: "toggle-wrapper", htmlFor: inputId }, index.h("input", { key: '92dee565687fc9a883f97091ead1bbb51df43779', type: "checkbox", role: "switch", "aria-checked": `${checked}`, checked: checked, disabled: disabled, id: inputId, required: required, ...inheritedAttributes }), index.h("div", { key: 'f057bc57714b26e84226ee931e09212b86dba69f', class: {
                'label-text-wrapper': true,
                'label-text-wrapper-hidden': !hasLabel,
            }, part: "label", id: inputLabelId, onClick: this.onDivLabelClick }, index.h("slot", { key: '345efb5ce20f8124d1e74877b4943edf82fe2f8e' }), this.renderHintText()), index.h("div", { key: 'fc1a7fb6b65064307fbe0a50178559a52d6aedb7', class: "native-wrapper" }, this.renderToggleControl()))));
    }
