...
var gestureController = require('./gesture-controller-CeJslptU.js');
var helpers = require('./helpers-CJUjGJOS.js');
var index$1 = require('./index-DqKXmMKk.js');
...
const Menu = class {
    constructor(hostRef) {
        ...
        this.handleFocus = (ev) => {
             ...
             */
            const lastOverlay = hardwareBackButton.getPresentedOverlay(document);
    ...
    sideChanged() {
        this.isEndSide = helpers.isEndSide(this.side, this.el);
        /**
    ...
    async connectedCallback() {
        ...
        if (this.type === undefined) {
            this.type = index.config.get('menuType', 'overlay');
        }
        const content = this.contentId !== undefined ? document.getElementById(this.contentId) : null;
        if (content === null) {
            index.printIonError('[ion-menu] - Must have a "content" element to listen for drag events on.');
            return;
        }
        if (this.el.contains(content)) {
            index.printIonError(`[ion-menu] - The "contentId" should refer to the main view's ion-content, not the ion-content inside of the ion-menu.`);
        }
        ...
        this.menuChanged();
        this.gesture = (await Promise.resolve().then(function () { return require('./index-DRPqwSvU.js'); })).createGesture({
            el: document,
    ...
    onBackdropClick(ev) {
        ...
        if (this._isOpen && this.lastOnEnd < ev.timeStamp - 100) {
            ...
            if (shouldClose) {
                ev.preventDefault();
                ev.stopPropagation();
                this.close(undefined, hardwareBackButton.BACKDROP);
            }
        }
    }
    onKeydown(ev) {
    ...
    trapKeyboardFocus(ev, doc) {
        ...
        if (this.el.contains(target)) {
             ...
             * here to avoid that.
             */
            hardwareBackButton.focusFirstDescendant(el);
            /**
            ...
            if (this.lastFocus === doc.activeElement) {
                hardwareBackButton.focusLastDescendant(el);
            }
        }
    }
    ...
    async loadAnimation() {
         ...
         * If the document direction changes, we need to create a new animation.
         */
        const isEndSide = helpers.isEndSide(this.side, this.el);
        ...
        if (!index.config.getBoolean('animated', true)) {
    ...
    onWillStart() {
        this.beforeAnimation(!this._isOpen, hardwareBackButton.GESTURE);
    ...
    onEnd(detail) {
        ...
        this.animation
            ...
            .onFinish(() => this.afterAnimation(shouldOpen, hardwareBackButton.GESTURE), { oneTimeCallback: true })
    ...
    updateState() {
        ...
        if (!isActive) {
             ...
             */
            this.afterAnimation(false, hardwareBackButton.GESTURE);
        }
    }
    render() {
         ...
         */
        return (index.h(index.Host, { key: '1208ba437fa58680325408d3d4c8580950da1d68', onKeyDown: hardwareBackButton.shouldUseCloseWatcher() ? null : this.onKeydown, role: "navigation", "aria-label": inheritedAttributes['aria-label'] || 'menu', class: {
                [mode]: true,
                [`menu-type-${type}`]: true,
            ...
            } }, index.h("div", { key: 'c0ddc957b7a7956b41901d77ae02d91e73071c55', class: "menu-inner", part: "container", ref: (el) => (this.menuInnerEl = el) }, index.h("slot", { key: '6e44c56116431a024f114ab85ded1b822c942fac' })), index.h("ion-backdrop", { key: '5f4bbcf84444d96ec6b02bf567e1aaf95f59078d', ref: (el) => (this.backdropEl = el), class: "menu-backdrop", tappable: false, stopPropagation: false, part: "backdrop" })));
    }
...
const MenuButton = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        const menuIcon = index.config.get('menuIcon', mode === 'ios' ? index$2.menuOutline : index$2.menuSharp);
        const hidden = this.autoHide && !this.visible;
        const attrs = {
            type: this.type,
        };
        const ariaLabel = inheritedAttributes['aria-label'] || 'menu';
        return (index.h(index.Host, { key: 'b8869377822b082c6c4d3f16135b50b733eabf65', onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, "aria-hidden": hidden ? 'true' : null, class: theme.createColorClasses(color, {
                [mode]: true,
                ...
                'ion-focusable': true,
            }) }, index.h("button", { key: '48fc0a7011414b60dd7d5136f247e937ae4bb8c8', ...attrs, disabled: disabled, class: "button-native", part: "native", "aria-label": ariaLabel }, index.h("span", { key: '8c712f28c5afd345e403a9afc525931112852708', class: "button-inner" }, index.h("slot", { key: 'dd872325e42baf435188478c8d1cfc416075089d' }, index.h("ion-icon", { key: 'a4f02bdb715b07792c17e12c7837873d70171f88', part: "icon", icon: menuIcon, mode: mode, lazy: false, "aria-hidden": "true" }))), mode === 'md' && index.h("ion-ripple-effect", { key: '564e2a8a804e14d1135502f7b17d8b7b9862e81b', type: "unbounded" }))));
    }
    get el() { return index.getElement(this); }
};
MenuButton.style = {
...
const MenuToggle = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        const hidden = this.autoHide && !this.visible;
        return (index.h(index.Host, { key: '76d21ea6493b8161860c941e3754fef1e20395cc', onClick: this.onClick, "aria-hidden": hidden ? 'true' : null, class: {
                [mode]: true,
                'menu-toggle-hidden': hidden,
            } }, index.h("slot", { key: '9383610fd3105e1928a38788eb596e313e2b07f8' })));
    }
};
