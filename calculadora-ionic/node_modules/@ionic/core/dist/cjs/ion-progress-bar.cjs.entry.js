...
const ProgressBar = class {
    ...
    render() {
        ...
        const paused = index.config.getBoolean('_testing');
        const mode = ionicGlobal.getIonMode(this);
        // If the progress is displayed as a solid bar.
        const progressSolid = buffer === 1;
        return (index.h(index.Host, { key: 'd53d39a3e2c0198164a9face62d3775f357b6914', role: "progressbar", "aria-valuenow": type === 'determinate' ? value : null, "aria-valuemin": "0", "aria-valuemax": "1", class: theme.createColorClasses(color, {
                [mode]: true,
