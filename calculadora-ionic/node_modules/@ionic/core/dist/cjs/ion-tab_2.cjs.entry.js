...
const Tab = class {
    ...
    prepareLazyLoaded() {
        ...
        if (this.loadPromise === undefined) {
            this.loadPromise = frameworkDelegate.attachComponent(this.delegate, this.el, this.component, ['ion-page']).catch((e) => {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8ecbd7a85d3370ed8ed40561cd8134e71584d6aa', role: "tabpanel", "aria-hidden": !active ? 'true' : null, "aria-labelledby": `tab-button-${tab}`, class: {
                'ion-page': component === undefined,
                'tab-hidden': !active,
            } }, index.h("slot", { key: '8d6326d75812888e33fd09665b7e588e1e270df1' })));
    }
...
const Tabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7b8c6455e0673e343d0c759ed85e0d9970de3bb8', onIonTabButtonClick: this.onTabClicked }, index.h("slot", { key: '7d0d840ae03312ca22bcb694ffca738d6648218e', name: "top" }), index.h("div", { key: 'f336d903800af34af0d36adfc94223b940111e6a', class: "tabs-inner" }, index.h("slot", { key: '14656154959a24ae176eff20f6463043180d2eae' })), index.h("slot", { key: '2be4d114f058d24b0e70fb12cfb0eccd3d6e6a74', name: "bottom" })));
    }
    get el() { return index.getElement(this); }
};
