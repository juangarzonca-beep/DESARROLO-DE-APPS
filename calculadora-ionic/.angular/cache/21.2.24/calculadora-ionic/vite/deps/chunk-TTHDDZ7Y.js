...
// node_modules/@ionic/core/components/p-DiqHxuia.js
...
var r2 = (o, s2, e2, r3, i2, l2, f, p, $) => {
  ...
  const g = a(r3).querySelector("ion-icon").getBoundingClientRect(), w = s2 ? g.width / 2 - (g.right - i2.right) + "px" : i2.left - g.width / 2 + "px", k = s2 ? `-${window.innerWidth - i2.right}px` : `${i2.left}px`, v = `${$.top}px`, T = `${i2.top}px`, A = e2 ? [{ offset: 0, transform: `translate3d(${k}, ${T}, 0)` }, { offset: 1, transform: `translate3d(${w}, ${v}, 0)` }] : [{ offset: 0, transform: `translate3d(${w}, ${v}, 0)` }, { offset: 1, transform: `translate3d(${k}, ${T}, 0)` }], B = e2 ? [{ offset: 0, opacity: 1, transform: h }, { offset: 1, opacity: 0, transform: x }] : [{ offset: 0, opacity: 0, transform: x }, { offset: 1, opacity: 1, transform: h }], I = e2 ? [{ offset: 0, opacity: 1, transform: "scale(1)" }, { offset: 0.2, opacity: 0, transform: "scale(0.6)" }, { offset: 1, opacity: 0, transform: "scale(0.6)" }] : [{ offset: 0, opacity: 0, transform: "scale(0.6)" }, { offset: 0.6, opacity: 0, transform: "scale(0.6)" }, { offset: 1, opacity: 1, transform: "scale(1)" }], N = r(), j = r(), O = r(), S = n("ion-back-button"), q = a(S).querySelector(".button-text"), z = a(S).querySelector("ion-icon");
  S.text = r3.text, S.mode = r3.mode, S.icon = r3.icon, S.color = r3.color, S.disabled = r3.disabled, S.style.setProperty("display", "block"), S.style.setProperty("position", "fixed"), j.addElement(z), N.addElement(q), O.addElement(S), O.beforeStyles({ position: "absolute", top: "0px", [u]: "0px" }).beforeAddWrite((() => {
    r3.style.setProperty("display", "none"), S.style.setProperty(b, d);
  })).afterAddWrite((() => {
    r3.style.setProperty("display", ""), S.style.setProperty("display", "none"), S.style.removeProperty(b);
  })).keyframes(A), N.beforeStyles({ "transform-origin": `${b} top` }).keyframes(B), j.beforeStyles({ "transform-origin": `${m} center` }).keyframes(I), o.addAnimation([N, j, O]);
};
...
var l = (n2, l2) => {
  try {
    ...
    const T = y.querySelector("ion-header.header-collapse-condense"), { forward: A, backward: B } = ((t, o, n3, l3, c3) => {
    ...
    if (w.forEach(((o) => {
      ...
      e2.forEach(((o) => {
        ...
        if (h2 && X2.addElement(h2), n4.addAnimation([s3, e3, d2, X2, y2]), k.addAnimation(n4), X2.fromTo(f, 0.99, 0), e3.fromTo(f, 0.99, 0), d2.fromTo(f, 0.99, 0), x) {
          ...
          const o2 = i2?.translucent;
          if (o2 ? y2.fromTo("transform", "translateX(0px)", b ? "translateX(-100%)" : "translateX(100%)") : y2.fromTo(f, "var(--opacity)", 0), h2 && !B) {
            const o3 = r();
...
//# sourceMappingURL=chunk-TTHDDZ7Y.js.map
