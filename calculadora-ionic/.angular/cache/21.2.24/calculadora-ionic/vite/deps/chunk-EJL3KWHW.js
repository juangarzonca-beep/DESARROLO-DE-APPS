...
// node_modules/@ionic/core/components/p-B7NtI9LF.js
var t;
var i = (e, o, i2) => {
...
var r = (t3) => {
  ...
  const K = t3, W2 = [], Z = [], x2 = [], I = [], M2 = [], P2 = [], B2 = [], q = [], z = [], G = [], H = [], J2 = "function" == typeof AnimationEffect || void 0 !== d2 && "function" == typeof d2.AnimationEffect, L2 = "function" == typeof Element && "function" == typeof Element.prototype.animate && J2, N = () => H, O = (e, o) => {
    const t4 = o.findIndex(((o2) => o2.c === e));
    t4 > -1 && o.splice(t4, 1);
  }, Q = (e, o) => ((o?.oneTimeCallback ? Z : W2).push({ c: e, o }), p2), U2 = () => {
    L2 && (H.forEach(((e) => {
      e.cancel();
    })), H.length = 0);
  }, V2 = () => {
    ...
    0 !== k2 && (k2--, 0 === k2 && ((() => {
      z.forEach(((e2) => e2())), G.forEach(((e2) => e2()));
      ...
      })), m2 = void 0, v3 = void 0, u2 = void 0, W2.forEach(((o2) => o2.c(e, p2))), Z.forEach(((o2) => o2.c(e, p2))), Z.length = 0, D2 = true, w2 && (T = true), w2 = true;
    })(), c2 && c2.animationFinish()));
  }, ie = () => {
    (() => {
      B2.forEach(((e2) => e2())), q.forEach(((e2) => e2()));
    ...
    e = Math.min(Math.max(e, 0), 0.9999), L2 && H.forEach(((o) => {
  ...
  }, ae = (e = false, o = true, t4) => (e && M2.forEach(((i2) => {
    i2.update(e, o, t4);
  })), L2 && re(t4), p2), se = () => {
    b2 && (L2 ? H.forEach(((e) => {
      e.pause();
    ...
    e?.sync && (j2 = true, Q((() => j2 = false), { oneTimeCallback: true })), b2 || ie(), T && (L2 && (ne(0), re()), T = false), D2 && (k2 = M2.length + 1, D2 = false);
    const t4 = () => {
      O(i2, Z), o();
    }, i2 = () => {
      O(t4, x2), o();
    };
    Q(i2, { oneTimeCallback: true }), x2.push({ c: t4, o: { oneTimeCallback: true } }), M2.forEach(((e2) => {
      e2.play();
    })), L2 ? (H.forEach(((e2) => {
      e2.play();
    })), 0 !== y2.length && 0 !== I.length || te()) : te(), F = false;
  })), fe = (e, o) => {
    const t4 = y2[0];
    return void 0 === t4 || void 0 !== t4.offset && 0 !== t4.offset ? y2 = [{ offset: 0, [e]: o }, ...y2] : t4[e] = o, p2;
  };
  return p2 = { parentAnimation: c2, elements: I, childAnimations: M2, id: K, animationFinish: te, from: fe, to: (e, o) => {
    const t4 = y2[y2.length - 1];
    return void 0 === t4 || void 0 !== t4.offset && 1 !== t4.offset ? y2 = [...y2, { offset: 1, [e]: o }] : t4[e] = o, p2;
  }, fromTo: (e, o, t4) => fe(e, o).to(e, t4), parent: (e) => (c2 = e, p2), play: de, pause: () => (M2.forEach(((e) => {
    e.pause();
  })), se(), p2), stop: () => {
    M2.forEach(((e) => {
      e.stop();
    })), b2 && (U2(), b2 = false), R = false, j2 = false, D2 = true, v3 = void 0, m2 = void 0, u2 = void 0, k2 = 0, T = false, w2 = true, F = false, x2.forEach(((e) => e.c(0, p2))), x2.length = 0;
  }, destroy: (e) => (M2.forEach(((o) => {
    o.destroy(e);
  })), ((e2) => {
    U2(), e2 && V2();
  })(e), I.length = 0, M2.length = 0, y2.length = 0, W2.length = 0, Z.length = 0, b2 = false, D2 = true, p2), keyframes: (e) => {
    const o = y2 !== e;
    return y2 = e, o && ((e2) => {
      L2 && N().forEach(((o2) => {
        const t4 = o2.effect;
    ...
    if (null != e) if (Array.isArray(e)) for (const o of e) o.parent(p2), M2.push(o);
    else e.parent(p2), M2.push(e);
    return p2;
  }, addElement: (o) => {
    if (null != o) if (1 === o.nodeType) I.push(o);
    else if (o.length >= 0) for (let e = 0; e < o.length; e++) I.push(o[e]);
    else d("createAnimation - Invalid addElement value.");
    return p2;
  }, update: ae, fill: (e) => (f3 = e, ae(true), p2), direction: (e) => (l2 = e, ae(true), p2), iterations: (e) => (d4 = e, ae(true), p2), duration: (e) => (L2 || 0 !== e || (e = 1), a2 = e, ae(true), p2), easing: (e) => (s2 = e, ae(true), p2), delay: (e) => (r3 = e, ae(true), p2), getWebAnimations: N, getKeyframes: () => y2, getFill: X, getDirection: Y, getDelay: oe, getIterations: ee, getEasing: $, getDuration: _, afterAddRead: (e) => (z.push(e), p2), afterAddWrite: (e) => (G.push(e), p2), afterClearStyles: (e = []) => {
    for (const o of e) S[o] = "";
    return p2;
  }, afterStyles: (e = {}) => (S = e, p2), afterRemoveClass: (e) => (h2 = n2(h2, e), p2), afterAddClass: (e) => (E2 = n2(E2, e), p2), beforeAddRead: (e) => (B2.push(e), p2), beforeAddWrite: (e) => (q.push(e), p2), beforeClearStyles: (e = []) => {
    for (const o of e) C2[o] = "";
    return p2;
  }, beforeStyles: (e = {}) => (C2 = e, p2), beforeRemoveClass: (e) => (A2 = n2(A2, e), p2), beforeAddClass: (e) => (g2 = n2(g2, e), p2), onFinish: Q, isRunning: () => 0 !== k2 && !F, progressStart: (e = false, o) => (M2.forEach(((t4) => {
    t4.progressStart(e, o);
  })), se(), R = e, b2 || ie(), ae(false, true, o), p2), progressStep: (e) => (M2.forEach(((o) => {
    o.progressStep(e);
  })), ne(e), p2), progressEnd: (e, o, t4) => (R = false, M2.forEach(((i2) => {
...
// node_modules/@ionic/core/components/p--8XqAiDn.js
...
var m = (n3, e) => {
  ...
  f2(a2), B(i2, a2, n3.direction), C(e, true), n3.showGoBack ? i2.classList.add("can-go-back") : i2.classList.remove("can-go-back"), x(i2, false), i2.style.setProperty("pointer-events", "none"), a2 && (x(a2, false), a2.style.setProperty("pointer-events", "none"));
};
var b = async (n3) => {
  const e = await h(n3);
...
var h = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-DiqHxuia-X6O6PBJX.js")).iosTransitionAnimation : (await import("./p-ls85vUWB-ULHNEMN3.js")).mdTransitionAnimation;
};
var y = async (n3, e) => {
  await k(e, true);
  const i2 = n3(e.baseEl, e);
  j(e.enteringEl, e.leavingEl);
  const a2 = await V(i2, e);
...
var P = async (e) => {
  ...
  return await k(e, o), j(i2, a2), E(i2, a2), { hasCompleted: true };
};
var k = async (n3, e) => {
  (void 0 !== n3.deepWait ? n3.deepWait : e) && await Promise.all([W(n3.enteringEl), W(n3.leavingEl)]), await D(n3.viewIsReady, n3.enteringEl);
};
var D = async (n3, e) => {
  n3 && await n3(e);
};
...
//# sourceMappingURL=chunk-EJL3KWHW.js.map
