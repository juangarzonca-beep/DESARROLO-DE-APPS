...
// node_modules/@ionic/core/components/p-DNT7yQ4z.js
var o2 = (o3) => {
  if (void 0 === o) return;
  let s, p, u, l = 0;
  const d = o3.getBoolean("animated", true) && o3.getBoolean("rippleEffect", true), v = /* @__PURE__ */ new WeakMap(), m = () => {
    u && clearTimeout(u), u = void 0, s && (D(false), s = void 0);
  }, w = (t, o4) => {
    if (t && t === s) return;
    ...
    if (s) {
      ...
      s.classList.contains(a) || T(s, i2, r2), D(true);
    }
    if (t) {
      const e = v.get(t);
...
//# sourceMappingURL=p-DNT7yQ4z-NQQGRW7N.js.map
